...
router.get('/makerspace', function (req, res, next) {
     MongoClient.connect('mongodb://abhijani123:password@cluster0-shard-00-00-8t9ca.mongodb.net:27017,cluster0-shard-00-01-8t9ca.mongodb.net:27017,cluster0-shard-00-02-8t9ca.mongodb.net:27017/testing?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin', function (err, db) {
            if (err) { return console.dir(err); }
